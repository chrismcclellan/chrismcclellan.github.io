...
function percentValue(input) {
    ...
    return {
        of: function of(total) {
            // input ..... total
            // ?     ..... 100
            total = parseFloat(total);
            return input * 100 / total;
        },
        get: function get(percent) {
            // ?       ..... input
            // percent ..... 100
            percent = parseFloat(percent);
            return percent / 100 * input;
        },
        from: function from(total) {
            // ?        ..... total
            // input    ..... 100
            total = parseFloat(total);
            return percentValue(input).get(total);
        },
        is: function is(howMuch) {
            // howMuch ..... ?
            // input   ..... 100
...
},{"./views":13,"jquery":"jquery","livereload-js":8}],13:[function(require,module,exports){
module.exports = {
    pages: require('./pages'),
    regions: require('./regions')
}
},{"./pages":18,"./regions":20}],14:[function(require,module,exports){
...
module.exports = function canopy() {
    ...
    //     $objective.addClass('flash');
    // }, 1200);
}


},{"lodash":10,"percent-value":11}],15:[function(require,module,exports){
...
},{"./canopy":14,"./me":16}],16:[function(require,module,exports){
var _ = require('lodash');
var percent = require("percent-value");
...
},{"lodash":10,"percent-value":11}],17:[function(require,module,exports){
...
},{"./home":15}],19:[function(require,module,exports){
module.exports = function() {
...
},{"./favicon":19}],"jquery":[function(require,module,exports){
/*!
